...
function kirim_email($to, $pesan)
{
	try {
		...
		$mail->SMTPAuth   = true;
		$mail->Username   = 'faisyahwulandaria@gmail.com';
		$mail->Password   = 'allahswt2797';
		$mail->SMTPSecure = 'tls';
		$mail->Port       = 587; // port ssl dan 465
		// pengirim dari email
		$mail->setFrom('faisyahwulandaria@gmail.com', 'Administrator !');
		// email yang akan dikirim
		$mail->addAddress($to);
		$mail->addCC('faisyahwulandaria@gmail.com');
		$mail->addBCC('faisyahwulandaria@gmail.com');
