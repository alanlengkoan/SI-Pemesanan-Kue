...
if(isset($_POST['btnSimpan'])){
	...
	if (count($pesanError)>=1 ){
		...
		$mySql	= "INSERT INTO barang (kd_barang, nm_barang, harga_jual, harga_retail, stok, keterangan, file_gambar,  kd_kategori) VALUES('$kodeBaru', '$txtNama', '$txtHrgJual', '$hargaretail', '$txtStok', '$txtKeterangan', '$nama_file', '$cmbKategori')";
...
<table class="table-list" width="100%" style="margin-top:0px;">
	<tr>
	  <th colspan="3"><strong>TAMBAH DATA KUE </strong></th>
	</tr>
	<tr>
	...
	<tr>
      ...
      <td><strong>:</strong></td>
      <td><input name="inphargaretail" type="text" size="20" maxlength="12" /></td>
    </tr>
	<tr>
