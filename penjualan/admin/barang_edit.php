...
if(isset($_POST['btnSimpan'])){	
	...
	$hargaretail = str_replace("'", "&acute;", $_POST['inphargaretail']);
	...
	$pesanError = array();
	if (trim($txtNama)=="") {
		$pesanError[] = "Data <b>Nama Kue</b> tidak boleh kosong !";		
	}	
	...
	if (count($pesanError)>=1 ){
		...
		$mySql	= "UPDATE barang SET nm_barang = '$txtNama', harga_jual = '$txtHrgJual', harga_retail = '$hargaretail', stok 		= '$txtStok', keterangan = '$txtKeterangan', file_gambar = '$nama_file', kd_kategori = '$cmbKategori' WHERE kd_barang = '$Kode'";
...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" name="frmedit">
  <table class="table-list" width="100%" style="margin-top:0px;">
	...
	<tr>
      <td><strong>Harga Retail  (Rp) </strong></td>
      <td><strong>:</strong></td>
      <td><input name="inphargaretail" type="text" value="<?= $myData['harga_retail'] ?>" size="20" maxlength="12" /></td>
    </tr>
    <tr>
