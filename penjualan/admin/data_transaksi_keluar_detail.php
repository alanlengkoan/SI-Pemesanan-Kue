...
<a href="?open=Data-Transaksi-Keluar"><img src="../assets/images/hapus.gif" style="width: 30px; height: 30px;" /></a>&nbsp;
<a href="data_transaksi_keluar_cetak.php?kode=<?= $kd ?>" target="_blank"><img src="../assets/images/btn_print.png" style="width: 30px; height: 30px;" /></a>