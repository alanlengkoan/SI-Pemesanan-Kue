...
<table width="800" border="0" cellpadding="2" cellspacing="1" class="table-list" >
  <tr>
    <th width="4%" align="center" bgcolor="#CCCCCC">
      <font color="#FF0066"><b>No</b></font>
    </th>
    <th width="9%" bgcolor="#CCCCCC">
      <font color="#FF0066"><b>Tanggal</b></font>
    </th>
    <th width="11%" bgcolor="#CCCCCC">
      <font color="#FF0066"><b>Kode Plg </b></font>
    </th>
    <th width="32%" bgcolor="#CCCCCC">
      <font color="#FF0066"><strong>Nama Pelanggan </strong></font>
    </th>
    <th width="13%" align="right" bgcolor="#CCCCCC">
      <font color="#FF0066">Total Kue </font>
    </th>
    <th width="17%" align="right" bgcolor="#CCCCCC">
      <font color="#FF0066"><b>Total Bayar (Rp) </b></font>
    </th>
    <th width="8%" align="right" bgcolor="#CCCCCC">
      <font color="#FF0066"><strong>Status </strong></font>
    </th>
    <td align="center" bgcolor="#CCCCCC">
      <font color="#FF0066"><b>Tools</b></font>
    </td>
  </tr>
  <?php
  ...
  $mySql = "SELECT pemesanan.*, pelanggan.nm_pelanggan, provinsi.biaya_kirim FROM pelanggan, pemesanan, provinsi WHERE pelanggan.kd_pelanggan=pemesanan.kd_pelanggan AND pemesanan.kd_provinsi=provinsi.kd_provinsi AND $SqlPeriode ORDER BY no_pemesanan DESC";
  ...
  while ($myData = mysqli_fetch_array($myQry)) {
    ...
    $my2Sql  = "SELECT SUM(harga * jumlah) As total_harga, SUM(jumlah) As total_barang FROM pemesanan_item WHERE no_pemesanan='$Kode'";
