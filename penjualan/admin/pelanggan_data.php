...
$pageQry  = mysqli_query($mysqli, $pageSql) or die ("error paging: ".mysql_error($mysqli));
  ...
  <tr>
	...
	<table class="table-list" width="100%" border="0" cellspacing="1" cellpadding="2">
      <tr>
        ...
        <th width="200"><font color="#FF0066">Nama Pelanggan</font></th>
        <th width="60"><font color="#FF0066">Kelamin</font></th>
        <th width="120"><font color="#FF0066">No. Telepon</font></th>
        <th width="119"><font color="#FF0066">Username</font></th>
        <td align="center" width="60" bgcolor="#CCCCCC"><font color="#FF0066"><strong>Tools</strong></font><b></b></td>
        </tr>
      <?php
	...
	?>
      <tr>
        ...
        <td width="50" align="center">
          <a href="?open=Pelanggan-Delete&Kode=<?php echo $Kode; ?>" target="_self" alt="Delete Data" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA PELANGGAN INI ... ?')"><img src="../assets/images/b_drop.png" style="width: 30px; height: 30px;"></a>
        </td>
      </tr>
      <?php } ?>
    </table></td>
