...
if(isset($_GET['Kode'])) {
	...
	$mySql  = "SELECT pemesanan.*, pelanggan.nm_pelanggan, provinsi.* FROM pemesanan, pelanggan, provinsi WHERE pemesanan.kd_pelanggan=pelanggan.kd_pelanggan AND pemesanan.kd_provinsi=provinsi.kd_provinsi AND pemesanan.no_pemesanan ='$Kode'";
...
?>
<p><b>* Keterangan Status :</b></p>
<ul>
  <li><b>Pesan :</b> Masih dalam proses dibungkus, atau <strong>Belum Dibungkus</strong>.</li>
