...
?>
<h2 style="margin: 0;">Data Pesanan</h2>
...
<h2 style="margin: 10px;">Data Pembayaran</h2>
...
$data  = mysqli_fetch_array($qry_p, MYSQLI_ASSOC);
?>
...
<table class="table-list" width="100%" align="center">
    ...
    <tr>
        ...
        <td width="20">:</td>
        <td>
            <?= ($data['status_pembayaran'] != 'lunas') ? 'Belum Lunas' : 'Lunas' ?>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td width="20">:</td>
        <td>
            Rp. <?= number_format($data['sisah_pembayaran']) ?>
        </td>
    </tr>
</table>
...
<table class="table-list" width="100%" align="center">
    ...
    <tbody>
        <?php 
        $kd    = $_GET['Kode'];
        $sql_i = "SELECT tb_retail_transaksi.kd_transaksi, kategori.nm_kategori, barang.nm_barang, tb_retail_transaksi.kd_barang, tb_retail_transaksi.jumlah, tb_retail_transaksi.harga, tb_retail_transaksi.sub_total FROM tb_retail_transaksi INNER JOIN barang ON tb_retail_transaksi.kd_barang = barang.kd_barang INNER JOIN kategori ON barang.kd_kategori = kategori.kd_kategori WHERE tb_retail_transaksi.kd_transaksi = '$kd'";
...
<a href="?open=Transaksi-Tampil"><img src="../assets/images/hapus.gif" width="22" height="22" /></a>&nbsp;