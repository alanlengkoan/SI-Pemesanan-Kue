...
<form name="form1" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" target="_self">
  <table width="100%" border="0" cellpadding="4" cellspacing="0">
	...
	<tr>
      ...
      <td><b>:</b></td>
      <td><textarea name="txtAlamatLengkap" cols="60" rows="5" placeholder="Masukkan Alamat Lengkap Anda!"></textarea></td>
    </tr>
    <tr> 
...
if(isset($_POST['btnDaftar'])){
	...
	if (count($pesanError)>=1 ){
		...
		if (kirim_email($txtEmail, $txtPesan) == '') {
			...
			$tanggal  = date('Y-m-d');
			$mySql    = "INSERT INTO pelanggan (kd_pelanggan, nm_pelanggan, kelamin, email, alamat_lengkap, no_telepon, username, password, tgl_daftar) VALUES ('$kodeBaru', '$txtNama', '$cmbKelamin', '$txtEmail', '$txtAlamatLeng', '$txtNoTelepon', '$txtUsername', MD5('$txtPassword_1'), '$tanggal')";
