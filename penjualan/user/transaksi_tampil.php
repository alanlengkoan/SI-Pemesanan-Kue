...
<table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
  ...
  $mySql = "SELECT pemesanan.*, pelanggan.nm_pelanggan, provinsi.biaya_kirim FROM pemesanan LEFT JOIN pelanggan ON pemesanan.kd_pelanggan= pelanggan.kd_pelanggan LEFT JOIN provinsi ON pemesanan.kd_provinsi=provinsi.kd_provinsi WHERE pemesanan.kd_pelanggan='$KodePelanggan' ORDER BY no_pemesanan";
  ...
  while ($myData = mysqli_fetch_array($myQry)) {
	...
	$hitungQry 	= mysqli_query($mysqli, $hitungSql) or die ("Gagal query 2 ".mysql_error());
    ...
    <tr> 
      ...
      <td align="center">
          <?php if ( $myData['metode_pembayaran'] == 'transfer' ) { ?>
            ...
            <?php } else { ?>
              <a href="?open=Konfirmasi&Kode=<?php echo $Kode; ?>" target="_blank" alt="Lihat Data" >Konfirmasi</a>
            <?php } ?>
          <?php } else { ?>
            <a href="transaksi_lihat.php?Kode=<?php echo $Kode; ?>" target="_blank" alt="Lihat Data" ><img src="../assets/images/btn_print.png"></a>
          <?php } ?>
